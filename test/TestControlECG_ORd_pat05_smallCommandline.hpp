...
//Commandline arguments
	...
	for (int i=0; i<size_roots;i++)
	{
        ...
        /* Mesh to use */
        std::string filepath = "/data/blanca-rodriguez/shug5389/meshes/chaste_tiny/HEART" ; 
	...
	HeartConfig::Instance()->SetKSPSolver("symmlq");
       ...
       //read the coords of the 20 regions 
        std::vector<std::vector<double> >  regions(num_nodes,std::vector<double>(4,1));
                ...
                std::ifstream infile;
                const std::string filename = "/data/blanca-rodriguez/shug5389/meshes/chaste_tiny/regions_full_tiny.txt";
 ...
 std::vector<unsigned int> rootnodes;    // a vector to hold apexbase data
        // open file    
                 std::ifstream inputFile("/data/blanca-rodriguez/shug5389/meshes/chaste09/roots/start.txt");
        //
                if (inputFile) {
                            int value;
