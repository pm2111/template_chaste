...
class CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables()
    {
        if (_lookup_table_0)
        {
            delete[] _lookup_table_0;
...
protected:
    CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables(const CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables&);
    CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables& operator= (const CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables&);
    CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables()
    {
        ...
        _lookup_table_0 = NULL;
        CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables> CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellORd2011m_fkatpFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellORd2011m_fkatpFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellORd2011m_fkatpFromCellMLCvodeOpt::CellORd2011m_fkatpFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellORd2011m_fkatpFromCellMLCvodeOpt>::Instance();
        Init();
    ...
    CellORd2011m_fkatpFromCellMLCvodeOpt::~CellORd2011m_fkatpFromCellMLCvodeOpt()
    {
    }
    
    AbstractLookupTableCollection* CellORd2011m_fkatpFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double CellORd2011m_fkatpFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellORd2011m_fkatpFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_INaL__INaL = NV_Ith_S(mParameters, 9) * (var_chaste_interface__membrane__v - var_reversal_potentials__ENa) * var_chaste_interface__INaL__mL * (((1.0 - var_INaL__fINaLp) * var_chaste_interface__INaL__hL) + (var_INaL__fINaLp * var_chaste_interface__INaL__hLp)); // microA_per_microF
        ...
        const double var_ICaL__PCa = NV_Ith_S(mParameters, 5) * 1.8; // dimensionless
        ...
        const double var_INaCa_i__Gncx = NV_Ith_S(mParameters, 12) * 1.3999999999999999; // milliS_per_microF
    ...
    void CellORd2011m_fkatpFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector CellORd2011m_fkatpFromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellORd2011m_fkatpFromCellMLCvodeOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellORd2011m_fkatpFromCellMLCvodeOpt)
#endif // CHASTE_CVODE
