#include "PostUpstrokeTimeAdaptivityControllerCLMono.hpp"

double PostUpstrokeTimeAdaptivityControllerCLMono::ComputeTimeStep(double currentTime, Vec currentSolution)
{
