...
class CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables()
    {
        if (_lookup_table_0)
        {
            delete[] _lookup_table_0;
...
protected:
    CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables(const CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables&);
    CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables& operator= (const CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables&);
    CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables()
    {
        ...
        _lookup_table_0 = NULL;
        CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables> CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellORd2011endo_fkatpFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellORd2011endo_fkatpFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellORd2011endo_fkatpFromCellMLCvodeOpt::CellORd2011endo_fkatpFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellORd2011endo_fkatpFromCellMLCvodeOpt>::Instance();
        Init();
    ...
    CellORd2011endo_fkatpFromCellMLCvodeOpt::~CellORd2011endo_fkatpFromCellMLCvodeOpt()
    {
    }
    
    AbstractLookupTableCollection* CellORd2011endo_fkatpFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double CellORd2011endo_fkatpFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellORd2011endo_fkatpFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_IKr__IKr = NV_Ith_S(mParameters, 10) * sqrt(NV_Ith_S(mParameters, 2) * 0.18518518518518517) * ((_lt_0_row[14] * var_chaste_interface__IKr__xrf) + (_lt_0_row[15] * var_chaste_interface__IKr__xrs)) * _lt_0_row[16] * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_INaCa_i__Gncx = NV_Ith_S(mParameters, 12); // milliS_per_microF
    ...
    void CellORd2011endo_fkatpFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector CellORd2011endo_fkatpFromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellORd2011endo_fkatpFromCellMLCvodeOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellORd2011endo_fkatpFromCellMLCvodeOpt)
#endif // CHASTE_CVODE
