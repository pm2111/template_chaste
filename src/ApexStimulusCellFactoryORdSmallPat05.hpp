...
#include "ten_tusscher_model_2006_endoCvodeOpt.hpp"
...
public:
    ...
    mrNodePerm(rNodePerm),
     mpLvDistancesFile(fopen("/data/blanca-rodriguez/shug5389/meshes/chaste_tiny/lv.mindists","rb")),
    mpRvDistancesFile(fopen("/data/blanca-rodriguez/shug5389/meshes/chaste_tiny/rv.mindists","rb")),
    mSpeed(speed)
    {
...
//	std::cout << "I get to line 134 of Dijkstra Cell Factory " << std::endl ;
        AbstractCvodeCell* p_cell = new CellORd2011epi_fkatpFromCellMLCvodeOpt(mpSolver, mpZeroStimulus); //defines a cell model and that the cell will not be stimulated 
