...
class CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables()
    {
        if (_lookup_table_0)
        {
            delete[] _lookup_table_0;
...
protected:
    CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables(const CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables&);
    CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables& operator= (const CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables&);
    CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables()
    {
        ...
        _lookup_table_0 = NULL;
        CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables> CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellToRORd_fkatp_endo_midFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellToRORd_fkatp_endo_midFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellToRORd_fkatp_endo_midFromCellMLCvodeOpt::CellToRORd_fkatp_endo_midFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                43,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellToRORd_fkatp_endo_midFromCellMLCvodeOpt>::Instance();
        Init();
    ...
    CellToRORd_fkatp_endo_midFromCellMLCvodeOpt::~CellToRORd_fkatp_endo_midFromCellMLCvodeOpt()
    {
    }
    
    AbstractLookupTableCollection* CellToRORd_fkatp_endo_midFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double CellToRORd_fkatp_endo_midFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellToRORd_fkatp_endo_midFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
    ...
    void CellToRORd_fkatp_endo_midFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellToRORd_fkatp_endo_midFromCellMLCvodeOpt>::Initialise(void)
{
