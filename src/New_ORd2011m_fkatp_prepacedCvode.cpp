...
#include "New_ORd2011m_fkatp_prepacedCvode.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode::CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode>::Instance();
        Init();
    ...
    CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode::~CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode()
    {
    }
    
    double CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKr__IKr = (var_IKr__GKr_b * 0.80000000000000004) * sqrt(var_extracellular__ko * 0.18518518518518517) * ((var_IKr__Axrf * var_chaste_interface__IKr__xrf) + ((1.0 - var_IKr__Axrf) * var_chaste_interface__IKr__xrs)) * (((1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 55.0) * 0.013333333333333334))) * 1.0) / (1.0 + exp((var_chaste_interface__membrane__v - 10.0) * 0.033333333333333333))) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_IKb__IKb = 0.0030000000000000001 * (1.0 / (1.0 + exp((-(var_chaste_interface__membrane__v - 14.48)) * 0.054525627044711013))) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
    ...
    void CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellNew_ORd2011m_fkatp_prepacedFromCellMLCvode>::Initialise(void)
{
