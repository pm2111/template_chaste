...
//! on Fri Dec 21 16:55:09 2018
//! 
//! <autogenerated>

#include "New_ORd2011epi_fkatp_prepaced.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellNew_ORd2011epi_fkatp_prepacedFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double CellNew_ORd2011epi_fkatp_prepacedFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[9];
    }
    
    CellNew_ORd2011epi_fkatp_prepacedFromCellML::CellNew_ORd2011epi_fkatp_prepacedFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellNew_ORd2011epi_fkatp_prepacedFromCellML>::Instance();
        Init();
    ...
    CellNew_ORd2011epi_fkatp_prepacedFromCellML::~CellNew_ORd2011epi_fkatp_prepacedFromCellML()
    {
    }
    
    double CellNew_ORd2011epi_fkatp_prepacedFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void CellNew_ORd2011epi_fkatp_prepacedFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<CellNew_ORd2011epi_fkatp_prepacedFromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellNew_ORd2011epi_fkatp_prepacedFromCellML)
