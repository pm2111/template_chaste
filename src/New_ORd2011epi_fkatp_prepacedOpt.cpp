...
#include "New_ORd2011epi_fkatp_prepacedOpt.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
class CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables()
    {
        if (_lookup_table_0)
        {
            delete[] _lookup_table_0;
...
protected:
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables(const CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables&);
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables& operator= (const CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables&);
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables()
    {
        ...
        _lookup_table_0 = NULL;
        CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables> CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[9];
    }
    
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt::CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt>::Instance();
        Init();

        // We have a default stimulus specified in the CellML file metadata
        this->mHasDefaultStimulusFromCellML = true;
        this->mParameters[0] = 1; // (c,ryr__Jrel_b) [dimensionless]
        this->mParameters[1] = 0.0001; // (c,ICaL__PCa_b) [dimensionless]
        this->mParameters[2] = 30; // (c,INaK__Pnak_b) [milliS_per_microF]
    }
    
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt::~CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt()
    {
    }
    
    AbstractLookupTableCollection* CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt::GetLookupTableCollection()
    {
        return CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables::Instance();
    }
    
    double CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_ICaL__PCa = mParameters[1] * 1.2; // dimensionless
    ...
    void CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_ryr__Jrel = (mParameters[0] * (1.0 - var_ryr__fJrelp) * var_chaste_interface__ryr__Jrelnp) + (mParameters[0] * var_ryr__fJrelp * var_chaste_interface__ryr__Jrelp); // millimolar_per_millisecond
...
template<>
void OdeSystemInformation<CellNew_ORd2011epi_fkatp_prepacedFromCellMLOpt>::Initialise(void)
{
