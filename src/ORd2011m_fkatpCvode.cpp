...
//! on Thu Feb 14 17:09:54 2019
//! 
//! <autogenerated>

#include "ORd2011m_fkatpCvode.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellORd2011m_fkatpFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double CellORd2011m_fkatpFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellORd2011m_fkatpFromCellMLCvode::CellORd2011m_fkatpFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellORd2011m_fkatpFromCellMLCvode>::Instance();
        Init();
    ...
    CellORd2011m_fkatpFromCellMLCvode::~CellORd2011m_fkatpFromCellMLCvode()
    {
    }
    
    double CellORd2011m_fkatpFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void CellORd2011m_fkatpFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector CellORd2011m_fkatpFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellORd2011m_fkatpFromCellMLCvode>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellORd2011m_fkatpFromCellMLCvode)
#endif // CHASTE_CVODE
