...
//! on Thu Feb 14 17:08:40 2019
//! 
//! <autogenerated>

#include "ORd2011epi_fkatpCvode.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellORd2011epi_fkatpFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double CellORd2011epi_fkatpFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellORd2011epi_fkatpFromCellMLCvode::CellORd2011epi_fkatpFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellORd2011epi_fkatpFromCellMLCvode>::Instance();
        Init();
    ...
    CellORd2011epi_fkatpFromCellMLCvode::~CellORd2011epi_fkatpFromCellMLCvode()
    {
    }
    
    double CellORd2011epi_fkatpFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICaL__PhiCaL = (4.0 * var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__cass * exp(2.0 * var_membrane__vfrt)) - (0.34100000000000003 * NV_Ith_S(mParameters, 1)))) / (exp(2.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaNa = (1.0 * var_membrane__vffrt * ((0.75 * var_chaste_interface__intracellular_ions__nass * exp(1.0 * var_membrane__vfrt)) - (0.75 * NV_Ith_S(mParameters, 3)))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaK = (1.0 * var_membrane__vffrt * ((0.75 * var_chaste_interface__intracellular_ions__kss * exp(1.0 * var_membrane__vfrt)) - (0.75 * NV_Ith_S(mParameters, 2)))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_IKr__IKr = (NV_Ith_S(mParameters, 10) * 1.3) * sqrt(NV_Ith_S(mParameters, 2) * 0.18518518518518517) * ((var_IKr__Axrf * var_chaste_interface__IKr__xrf) + ((1.0 - var_IKr__Axrf) * var_chaste_interface__IKr__xrs)) * (((1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 55.0) * 0.013333333333333334))) * 1.0) / (1.0 + exp((var_chaste_interface__membrane__v - 10.0) * 0.033333333333333333))) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_INaCa_i__h7_i = 1.0 + ((NV_Ith_S(mParameters, 3) * 0.011348161597821153) * (1.0 + (1.0 / var_INaCa_i__hna))); // dimensionless
        const double var_INaCa_i__h8_i = NV_Ith_S(mParameters, 3) / (88.120000000000005 * var_INaCa_i__hna * var_INaCa_i__h7_i); // dimensionless
        ...
        const double var_INaCa_i__h7_ss = 1.0 + ((NV_Ith_S(mParameters, 3) * 0.011348161597821153) * (1.0 + (1.0 / var_INaCa_i__hna))); // dimensionless
        const double var_INaCa_i__h8_ss = NV_Ith_S(mParameters, 3) / (88.120000000000005 * var_INaCa_i__hna * var_INaCa_i__h7_ss); // dimensionless
        ...
        const double var_INaK__a3 = (1899.0 * pow(NV_Ith_S(mParameters, 2) * 2.7917364600781687, 2.0)) / ((pow(1.0 + (NV_Ith_S(mParameters, 3) / var_INaK__Knao), 3.0) + pow(1.0 + (NV_Ith_S(mParameters, 2) * 2.7917364600781687), 2.0)) - 1.0); // dimensionless
        const double var_INaK__b2 = (39.399999999999999 * pow(NV_Ith_S(mParameters, 3) / var_INaK__Knao, 3.0)) / ((pow(1.0 + (NV_Ith_S(mParameters, 3) / var_INaK__Knao), 3.0) + pow(1.0 + (NV_Ith_S(mParameters, 2) * 2.7917364600781687), 2.0)) - 1.0); // dimensionless
        ...
        const double var_INab__INab = (3.75e-10 * var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__nai * exp(var_membrane__vfrt)) - NV_Ith_S(mParameters, 3))) / (exp(var_membrane__vfrt) - 1.0); // microA_per_microF
        ...
        const double var_ICab__ICab = (var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__cai * exp(2.0 * var_membrane__vfrt)) - (0.34100000000000003 * NV_Ith_S(mParameters, 1))) * 9.9999999999999995e-08) / (exp(2.0 * var_membrane__vfrt) - 1.0); // microA_per_microF
    ...
    void CellORd2011epi_fkatpFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector CellORd2011epi_fkatpFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellORd2011epi_fkatpFromCellMLCvode>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellORd2011epi_fkatpFromCellMLCvode)
#endif // CHASTE_CVODE
