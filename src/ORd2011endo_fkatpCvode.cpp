...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellORd2011endo_fkatpFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double CellORd2011endo_fkatpFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellORd2011endo_fkatpFromCellMLCvode::CellORd2011endo_fkatpFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellORd2011endo_fkatpFromCellMLCvode>::Instance();
        Init();
    ...
    CellORd2011endo_fkatpFromCellMLCvode::~CellORd2011endo_fkatpFromCellMLCvode()
    {
    }
    
    double CellORd2011endo_fkatpFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void CellORd2011endo_fkatpFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector CellORd2011endo_fkatpFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellORd2011endo_fkatpFromCellMLCvode>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellORd2011endo_fkatpFromCellMLCvode)
#endif // CHASTE_CVODE
