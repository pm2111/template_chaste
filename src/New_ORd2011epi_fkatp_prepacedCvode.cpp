...
//! on Fri Dec 21 16:55:27 2018
//! 
//! <autogenerated>

#include "New_ORd2011epi_fkatp_prepacedCvode.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode::CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode>::Instance();
        Init();
    ...
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode::~CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode()
    {
    }
    
    double CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICaL__PhiCaL = (4.0 * var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__cass * exp(2.0 * var_membrane__vfrt)) - (0.34100000000000003 * var_extracellular__cao))) / (exp(2.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaNa = (1.0 * var_membrane__vffrt * ((0.75 * var_chaste_interface__intracellular_ions__nass * exp(1.0 * var_membrane__vfrt)) - (0.75 * var_extracellular__nao))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaK = (1.0 * var_membrane__vffrt * ((0.75 * var_chaste_interface__intracellular_ions__kss * exp(1.0 * var_membrane__vfrt)) - (0.75 * var_extracellular__ko))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_IKr__IKr = (var_IKr__GKr_b * 1.3) * sqrt(var_extracellular__ko * 0.18518518518518517) * ((var_IKr__Axrf * var_chaste_interface__IKr__xrf) + ((1.0 - var_IKr__Axrf) * var_chaste_interface__IKr__xrs)) * (((1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 55.0) * 0.013333333333333334))) * 1.0) / (1.0 + exp((var_chaste_interface__membrane__v - 10.0) * 0.033333333333333333))) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_INab__INab = (3.75e-10 * var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__nai * exp(var_membrane__vfrt)) - var_extracellular__nao)) / (exp(var_membrane__vfrt) - 1.0); // microA_per_microF
        const double var_IKb__IKb = 0.0018 * (1.0 / (1.0 + exp((-(var_chaste_interface__membrane__v - 14.48)) * 0.054525627044711013))) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_ICab__ICab = (var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__cai * exp(2.0 * var_membrane__vfrt)) - (0.34100000000000003 * var_extracellular__cao)) * 9.9999999999999995e-08) / (exp(2.0 * var_membrane__vfrt) - 1.0); // microA_per_microF
    ...
    void CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_INa__hss = 1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 78.5) * 0.16077170418006431)); // dimensionless
        const double var_INa__ths = 1.0 / ((0.0097940000000000006 * exp((-(var_chaste_interface__membrane__v + 17.949999999999999)) * 0.035650623885918005)) + (0.33429999999999999 * exp((var_chaste_interface__membrane__v + 5.7300000000000004) * 0.017649135192375574))); // millisecond
        const double var_INa__jss = var_INa__hss; // dimensionless
        const double var_INa__tj = 4.859 + (1.0 / ((0.86280000000000001 * exp((-(var_chaste_interface__membrane__v + 116.72580000000001)) * 0.13157029142819551)) + (1.1095999999999999 * exp((var_chaste_interface__membrane__v + 6.2718999999999996) * 0.11067088691648774)))); // millisecond
        ...
        const double var_Ito__delta_epi = 1.0 - (0.94999999999999996 / (1.0 + exp((var_chaste_interface__membrane__v + 70.0) * 0.20000000000000001))); // dimensionless
        const double var_Ito__tiF = (4.5620000000000003 + (1.0 / ((0.39329999999999998 * exp((-(var_chaste_interface__membrane__v + 100.0)) * 0.01)) + (0.08004 * exp((var_chaste_interface__membrane__v + 50.0) * 0.060277275467148887))))) * var_Ito__delta_epi; // millisecond
        const double var_Ito__tiS = (23.620000000000001 + (1.0 / ((0.0014159999999999999 * exp((-(var_chaste_interface__membrane__v + 96.519999999999996)) * 0.016934801016088061)) + (1.7800000000000001e-08 * exp((var_chaste_interface__membrane__v + 114.09999999999999) * 0.12377769525931426))))) * var_Ito__delta_epi; // millisecond
        ...
        const double d_dt_chaste_interface__INa__hf = (var_INa__hss - var_chaste_interface__INa__hf) / (1.0 / ((3.6859999999999999e-06 * exp((-(var_chaste_interface__membrane__v + 3.8875000000000002)) * 0.12726046399165172)) + (16.0 * exp((var_chaste_interface__membrane__v - 0.49630000000000002) * 0.10888146075367747)))); // per_millisecond
        ...
        const double d_dt_chaste_interface__INa__hsp = ((1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 84.700000000000003) * 0.16077170418006431))) - var_chaste_interface__INa__hsp) / (3.0 * var_INa__ths); // per_millisecond
...
template<>
void OdeSystemInformation<CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvode)
#endif // CHASTE_CVODE
