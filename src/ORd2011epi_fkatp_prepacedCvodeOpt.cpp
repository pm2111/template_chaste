...
//! on Fri Dec 21 16:55:36 2018
//! 
//! <autogenerated>

#include "New_ORd2011epi_fkatp_prepacedCvodeOpt.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
class CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables()
    {
        if (_lookup_table_0)
        {
            delete[] _lookup_table_0;
...
protected:
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables(const CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables&);
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables& operator= (const CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables&);
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables()
    {
        ...
        _lookup_table_0 = NULL;
        CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][40] = 1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 78.5) * 0.16077170418006431));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][41] = 1.0 / ((3.6859999999999999e-06 * exp((-(var_chaste_interface__membrane__v + 3.8875000000000002)) * 0.12726046399165172)) + (16.0 * exp((var_chaste_interface__membrane__v - 0.49630000000000002) * 0.10888146075367747)));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][42] = 1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 78.5) * 0.16077170418006431));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][43] = 1.0 / ((0.0097940000000000006 * exp((-(var_chaste_interface__membrane__v + 17.949999999999999)) * 0.035650623885918005)) + (0.33429999999999999 * exp((var_chaste_interface__membrane__v + 5.7300000000000004) * 0.017649135192375574)));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][44] = 1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 78.5) * 0.16077170418006431));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][45] = 4.859 + (1.0 / ((0.86280000000000001 * exp((-(var_chaste_interface__membrane__v + 116.72580000000001)) * 0.13157029142819551)) + (1.1095999999999999 * exp((var_chaste_interface__membrane__v + 6.2718999999999996) * 0.11067088691648774))));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][46] = 1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 84.700000000000003) * 0.16077170418006431));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][47] = 3.0 * (1.0 / ((0.0097940000000000006 * exp((-(var_chaste_interface__membrane__v + 17.949999999999999)) * 0.035650623885918005)) + (0.33429999999999999 * exp((var_chaste_interface__membrane__v + 5.7300000000000004) * 0.017649135192375574))));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][48] = 1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 78.5) * 0.16077170418006431));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][49] = 1.46 * (4.859 + (1.0 / ((0.86280000000000001 * exp((-(var_chaste_interface__membrane__v + 116.72580000000001)) * 0.13157029142819551)) + (1.1095999999999999 * exp((var_chaste_interface__membrane__v + 6.2718999999999996) * 0.11067088691648774)))));
            }
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][57] = (4.5620000000000003 + (1.0 / ((0.39329999999999998 * exp((-(var_chaste_interface__membrane__v + 100.0)) * 0.01)) + (0.08004 * exp((var_chaste_interface__membrane__v + 50.0) * 0.060277275467148887))))) * (1.0 - (0.94999999999999996 / (1.0 + exp((var_chaste_interface__membrane__v + 70.0) * 0.20000000000000001))));
            }
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][59] = (23.620000000000001 + (1.0 / ((0.0014159999999999999 * exp((-(var_chaste_interface__membrane__v + 96.519999999999996)) * 0.016934801016088061)) + (1.7800000000000001e-08 * exp((var_chaste_interface__membrane__v + 114.09999999999999) * 0.12377769525931426))))) * (1.0 - (0.94999999999999996 / (1.0 + exp((var_chaste_interface__membrane__v + 70.0) * 0.20000000000000001))));
            }
...
private:
    ...
    static std::shared_ptr<CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables> CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt::CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt>::Instance();
        Init();

        // We have a default stimulus specified in the CellML file metadata
        this->mHasDefaultStimulusFromCellML = true;
        NV_Ith_S(this->mParameters, 0) = 1; // (c,ryr__Jrel_b) [dimensionless]
        NV_Ith_S(this->mParameters, 1) = 0.0001; // (c,ICaL__PCa_b) [dimensionless]
        NV_Ith_S(this->mParameters, 2) = 30; // (c,INaK__Pnak_b) [milliS_per_microF]
    }
    
    CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt::~CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt()
    {
    }
    
    AbstractLookupTableCollection* CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        // Units: millivolt; Initial value: -87.9352225677359
        double var_chaste_interface__CaMK__CaMKt = NV_Ith_S(rY, 1);
        // Units: millimolar; Initial value: 0.0158721323019959
        double var_chaste_interface__intracellular_ions__nai = NV_Ith_S(rY, 2);
        // Units: millimolar; Initial value: 7.88539265137707
        ...
        // Units: millimolar; Initial value: 143.97405653803
        ...
        // Units: millimolar; Initial value: 7.5827860772408e-5
        double var_chaste_interface__intracellular_ions__cai = NV_Ith_S(rY, 9);
        // Units: millimolar; Initial value: 7.5827860772408e-5
        double var_chaste_interface__INa__m = NV_Ith_S(rY, 10);
        // Units: dimensionless; Initial value: 0.00739352644407402
        double var_chaste_interface__INa__hf = NV_Ith_S(rY, 11);
        // Units: dimensionless; Initial value: 0.820075281103776
        double var_chaste_interface__INa__hs = NV_Ith_S(rY, 12);
        // Units: dimensionless; Initial value: 0.820076826831958
        double var_chaste_interface__INa__j = NV_Ith_S(rY, 13);
        // Units: dimensionless; Initial value: 0.819970732188633
        double var_chaste_interface__INa__hsp = NV_Ith_S(rY, 14);
        // Units: dimensionless; Initial value: 0.627141840409949
        double var_chaste_interface__INa__jp = NV_Ith_S(rY, 15);
        // Units: dimensionless; Initial value: 0.819789630447152
        double var_chaste_interface__INaL__mL = NV_Ith_S(rY, 16);
        // Units: dimensionless; Initial value: 0.000190660931415989
        double var_chaste_interface__INaL__hL = NV_Ith_S(rY, 17);
        // Units: dimensionless; Initial value: 0.501603724645503
        double var_chaste_interface__INaL__hLp = NV_Ith_S(rY, 18);
        // Units: dimensionless; Initial value: 0.275584489369064
        double var_chaste_interface__Ito__a = NV_Ith_S(rY, 19);
        // Units: dimensionless; Initial value: 0.00100560514679136
        double var_chaste_interface__Ito__iF = NV_Ith_S(rY, 20);
        // Units: dimensionless; Initial value: 0.999548998649096
        double var_chaste_interface__Ito__iS = NV_Ith_S(rY, 21);
        // Units: dimensionless; Initial value: 0.999540900084287
        double var_chaste_interface__Ito__ap = NV_Ith_S(rY, 22);
        // Units: dimensionless; Initial value: 0.000512384099657561
        double var_chaste_interface__Ito__iFp = NV_Ith_S(rY, 23);
        // Units: dimensionless; Initial value: 0.99954899898377
        double var_chaste_interface__Ito__iSp = NV_Ith_S(rY, 24);
        // Units: dimensionless; Initial value: 0.999547271129262
        double var_chaste_interface__ICaL__d = NV_Ith_S(rY, 25);
        // Units: dimensionless; Initial value: 2.37796720732212e-9
        double var_chaste_interface__ICaL__ff = NV_Ith_S(rY, 26);
        // Units: dimensionless; Initial value: 0.999999990709364
        double var_chaste_interface__ICaL__fs = NV_Ith_S(rY, 27);
        // Units: dimensionless; Initial value: 0.9224011559135
        double var_chaste_interface__ICaL__fcaf = NV_Ith_S(rY, 28);
        // Units: dimensionless; Initial value: 0.999999990709405
        double var_chaste_interface__ICaL__fcas = NV_Ith_S(rY, 29);
        // Units: dimensionless; Initial value: 0.999879775980899
        double var_chaste_interface__ICaL__jca = NV_Ith_S(rY, 30);
        // Units: dimensionless; Initial value: 0.999982588925409
        double var_chaste_interface__ICaL__ffp = NV_Ith_S(rY, 31);
        // Units: dimensionless; Initial value: 0.999999990707487
        double var_chaste_interface__ICaL__fcafp = NV_Ith_S(rY, 32);
        // Units: dimensionless; Initial value: 0.999999990707601
        double var_chaste_interface__ICaL__nca = NV_Ith_S(rY, 33);
        // Units: dimensionless; Initial value: 0.00169427136558335
        double var_chaste_interface__IKr__xrf = NV_Ith_S(rY, 34);
        // Units: dimensionless; Initial value: 8.12337011329896e-6
        double var_chaste_interface__IKr__xrs = NV_Ith_S(rY, 35);
        // Units: dimensionless; Initial value: 0.427865956903441
        double var_chaste_interface__IKs__xs1 = NV_Ith_S(rY, 36);
        // Units: dimensionless; Initial value: 0.241977533378165
        double var_chaste_interface__IKs__xs2 = NV_Ith_S(rY, 37);
        // Units: dimensionless; Initial value: 0.000194270872563605
        double var_chaste_interface__IK1__xk1 = NV_Ith_S(rY, 38);
        // Units: dimensionless; Initial value: 0.996777088227753
        
        // Lookup table indexing
        const bool _oob_0 = CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_INaL__GNaL_b = 0.0074999999999999997; // milliS_per_microF
        const double var_INaL__INaL = (var_INaL__GNaL_b * 0.59999999999999998) * (var_chaste_interface__membrane__v - var_reversal_potentials__ENa) * var_chaste_interface__INaL__mL * (((1.0 - var_INaL__fINaLp) * var_chaste_interface__INaL__hL) + (var_INaL__fINaLp * var_chaste_interface__INaL__hLp)); // microA_per_microF
        ...
        const double var_ICaL__PCa = NV_Ith_S(mParameters, 1) * 1.2; // dimensionless
        ...
        const double var_ICaL__PhiCaL = (4.0 * ((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((var_chaste_interface__intracellular_ions__cass * _lt_0_row[8]) - (0.34100000000000003 * var_extracellular__cao))) / _lt_0_row[9]; // dimensionless
        ...
        const double var_ICaL__PhiCaNa = (1.0 * ((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((0.75 * var_chaste_interface__intracellular_ions__nass * _lt_0_row[10]) - (0.75 * var_extracellular__nao))) / _lt_0_row[11]; // dimensionless
        ...
        const double var_ICaL__PhiCaK = (1.0 * ((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((0.75 * var_chaste_interface__intracellular_ions__kss * _lt_0_row[12]) - (0.75 * var_extracellular__ko))) / _lt_0_row[13]; // dimensionless
        ...
        const double var_IKr__GKr_b = 0.045999999999999999; // milliS_per_microF
        const double var_IKr__IKr = (var_IKr__GKr_b * 1.3) * sqrt(var_extracellular__ko * 0.18518518518518517) * ((_lt_0_row[14] * var_chaste_interface__IKr__xrf) + (_lt_0_row[15] * var_chaste_interface__IKr__xrs)) * _lt_0_row[16] * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        const double var_IKs__GKs_b = 0.0033999999999999998; // milliS_per_microF
        const double var_IKs__IKs = (var_IKs__GKs_b * 1.3999999999999999) * (1.0 + (0.59999999999999998 / (1.0 + pow(3.8000000000000002e-05 / var_chaste_interface__intracellular_ions__cai, 1.3999999999999999)))) * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2 * (var_chaste_interface__membrane__v - (26.712338705498265 * log((var_extracellular__ko + (0.018329999999999999 * var_extracellular__nao)) / (var_chaste_interface__intracellular_ions__ki + (0.018329999999999999 * var_chaste_interface__intracellular_ions__nai))))); // microA_per_microF
        const double var_IK1__GK1_b = 0.1908; // milliS_per_microF
        const double var_IK1__IK1 = (var_IK1__GK1_b * 1.2) * sqrt(var_extracellular__ko) * (1.0 / (1.0 + exp(((var_chaste_interface__membrane__v + 105.8) - (2.6000000000000001 * var_extracellular__ko)) * 0.10534077741493732))) * var_chaste_interface__IK1__xk1 * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        const double var_I_katp__fkatp = 0.0; // dimensionless
        const double var_I_katp__I_katp = var_I_katp__fkatp * pow(var_extracellular__ko * 0.18518518518518517, 0.23999999999999999) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK) * 0.067692307692307704; // microA_per_microF
        ...
        const double var_INaCa_i__h7_i = 1.0 + ((var_extracellular__nao * 0.011348161597821153) * _lt_0_row[19]); // dimensionless
        const double var_INaCa_i__h8_i = var_extracellular__nao / (88.120000000000005 * _lt_0_row[20] * var_INaCa_i__h7_i); // dimensionless
        ...
        const double var_INaCa_i__Gncx = var_INaCa_i__Gncx_b * 1.1000000000000001; // milliS_per_microF
        ...
        const double var_INaCa_i__h7_ss = 1.0 + ((var_extracellular__nao * 0.011348161597821153) * _lt_0_row[24]); // dimensionless
        const double var_INaCa_i__h8_ss = var_extracellular__nao / (88.120000000000005 * _lt_0_row[25] * var_INaCa_i__h7_ss); // dimensionless
        ...
        const double var_INaK__a3 = (1899.0 * pow(var_extracellular__ko * 2.7917364600781687, 2.0)) / ((pow(1.0 + (var_extracellular__nao / _lt_0_row[31]), 3.0) + pow(1.0 + (var_extracellular__ko * 2.7917364600781687), 2.0)) - 1.0); // dimensionless
        const double var_INaK__b2 = (39.399999999999999 * pow(var_extracellular__nao / _lt_0_row[29], 3.0)) / ((pow(1.0 + (var_extracellular__nao / _lt_0_row[30]), 3.0) + pow(1.0 + (var_extracellular__ko * 2.7917364600781687), 2.0)) - 1.0); // dimensionless
        ...
        const double var_INaK__INaK = (NV_Ith_S(mParameters, 2) * 0.90000000000000002) * ((1.0 * (3.0 * (((var_INaK__x1 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * var_INaK__a3) - ((var_INaK__x2 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * var_INaK__b3)))) + (1.0 * (2.0 * (((var_INaK__x4 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * 9.120000000000001) - ((var_INaK__x3 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * var_INaK__a1))))); // microA_per_microF
        const double var_INab__INab = (3.75e-10 * ((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((var_chaste_interface__intracellular_ions__nai * _lt_0_row[34]) - var_extracellular__nao)) / _lt_0_row[35]; // microA_per_microF
        const double var_IKb__IKb = 0.0018 * _lt_0_row[33] * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_ICab__ICab = (((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((var_chaste_interface__intracellular_ions__cai * _lt_0_row[36]) - (0.34100000000000003 * var_extracellular__cao)) * 9.9999999999999995e-08) / _lt_0_row[37]; // microA_per_microF
        ...
        const double var_chaste_interface__i_ionic = (var_chaste_interface__INa__INa + var_INaL__INaL + var_Ito__Ito + var_chaste_interface__ICaL__ICaL + var_ICaL__ICaNa + var_ICaL__ICaK + var_chaste_interface__IKr__IKr + var_chaste_interface__IKs__IKs + var_chaste_interface__IK1__IK1 + var_INaCa_i__INaCa_i + var_INaCa_i__INaCa_ss + var_INaK__INaK + var_INab__INab + var_IKb__IKb + var_IpCa__IpCa + var_ICab__ICab + var_chaste_interface__I_katp__I_katp) * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
    ...
    void CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        // Units: millimolar; Initial value: 1.97684814121841
        ...
        // Units: dimensionless; Initial value: 4.54106930955554e-7
        double var_chaste_interface__ryr__Jrelp = NV_Ith_S(rY, 40);
        // Units: dimensionless; Initial value: 5.67518577897119e-7
...
// LCOV_EXCL_STOP
        ...
        const double var_SERCA__Jup = var_SERCA__Jup_b * ((((1.0 - var_SERCA__fJupp) * ((var_chaste_interface__intracellular_ions__cai * 0.0056875000000000007) / (var_chaste_interface__intracellular_ions__cai + 0.00092000000000000003))) + (var_SERCA__fJupp * ((var_chaste_interface__intracellular_ions__cai * 0.015640625000000002) / ((var_chaste_interface__intracellular_ions__cai + 0.00092000000000000003) - 0.00017000000000000001)))) - ((0.0039375 * var_chaste_interface__intracellular_ions__cansr) * 0.066666666666666666)); // millimolar_per_millisecond
        ...
        const double var_ryr__Jrel = (NV_Ith_S(mParameters, 0) * (1.0 - var_ryr__fJrelp) * var_chaste_interface__ryr__Jrelnp) + (NV_Ith_S(mParameters, 0) * var_ryr__fJrelp * var_chaste_interface__ryr__Jrelp); // millimolar_per_millisecond
        ...
        const double d_dt_chaste_interface__IK1__xk1 = ((1.0 / (1.0 + exp((-(var_chaste_interface__membrane__v + (2.5537999999999998 * var_extracellular__ko) + 144.59)) / ((1.5691999999999999 * var_extracellular__ko) + 3.8115000000000001)))) - var_chaste_interface__IK1__xk1) / _lt_0_row[89]; // per_millisecond
...
template<>
void OdeSystemInformation<CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt>::Initialise(void)
{
    ...
    this->mInitialConditions.push_back(-87.9352225677359);

    // rY[1]:
    this->mVariableNames.push_back("CaMK__CaMKt");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.0158721323019959);

    // rY[2]:
    this->mVariableNames.push_back("cytosolic_sodium_concentration");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(7.88539265137707);
    ...
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(143.97405653803);
    ...
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(7.5827860772408e-5);

    // rY[7]:
    this->mVariableNames.push_back("intracellular_ions__cansr");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(1.97684814121841);
    ...
    this->mInitialConditions.push_back(0.00739352644407402);

    // rY[11]:
    this->mVariableNames.push_back("INa__hf");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.820075281103776);

    // rY[12]:
    this->mVariableNames.push_back("INa__hs");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.820076826831958);

    // rY[13]:
    this->mVariableNames.push_back("membrane_fast_sodium_current_j_gate");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.819970732188633);

    // rY[14]:
    this->mVariableNames.push_back("INa__hsp");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.627141840409949);

    // rY[15]:
    this->mVariableNames.push_back("INa__jp");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.819789630447152);

    // rY[16]:
    this->mVariableNames.push_back("INaL__mL");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.000190660931415989);

    // rY[17]:
    this->mVariableNames.push_back("INaL__hL");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.501603724645503);

    // rY[18]:
    this->mVariableNames.push_back("INaL__hLp");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.275584489369064);

    // rY[19]:
    this->mVariableNames.push_back("Ito__a");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.00100560514679136);

    // rY[20]:
    this->mVariableNames.push_back("Ito__iF");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.999548998649096);

    // rY[21]:
    this->mVariableNames.push_back("Ito__iS");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.999540900084287);

    // rY[22]:
    this->mVariableNames.push_back("Ito__ap");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.000512384099657561);

    // rY[23]:
    this->mVariableNames.push_back("Ito__iFp");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.99954899898377);

    // rY[24]:
    this->mVariableNames.push_back("Ito__iSp");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.999547271129262);

    // rY[25]:
    this->mVariableNames.push_back("ICaL__d");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(2.37796720732212e-9);

    // rY[26]:
    this->mVariableNames.push_back("ICaL__ff");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.999999990709364);

    // rY[27]:
    this->mVariableNames.push_back("ICaL__fs");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.9224011559135);

    // rY[28]:
    this->mVariableNames.push_back("ICaL__fcaf");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.999999990709405);

    // rY[29]:
    this->mVariableNames.push_back("ICaL__fcas");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.999879775980899);

    // rY[30]:
    this->mVariableNames.push_back("ICaL__jca");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.999982588925409);

    // rY[31]:
    this->mVariableNames.push_back("ICaL__ffp");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.999999990707487);

    // rY[32]:
    this->mVariableNames.push_back("ICaL__fcafp");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.999999990707601);

    // rY[33]:
    this->mVariableNames.push_back("ICaL__nca");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.00169427136558335);

    // rY[34]:
    this->mVariableNames.push_back("IKr__xrf");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(8.12337011329896e-6);

    // rY[35]:
    this->mVariableNames.push_back("IKr__xrs");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.427865956903441);

    // rY[36]:
    this->mVariableNames.push_back("IKs__xs1");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.241977533378165);

    // rY[37]:
    this->mVariableNames.push_back("IKs__xs2");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.000194270872563605);

    // rY[38]:
    this->mVariableNames.push_back("IK1__xk1");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.996777088227753);

    // rY[39]:
    this->mVariableNames.push_back("ryr__Jrelnp");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(4.54106930955554e-7);

    // rY[40]:
    this->mVariableNames.push_back("ryr__Jrelp");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(5.67518577897119e-7);

    // mParameters[0]:
    this->mParameterNames.push_back("membrane_Jrel_conductance");
...
CHASTE_CLASS_EXPORT(CellNew_ORd2011epi_fkatp_prepacedFromCellMLCvodeOpt)
#endif // CHASTE_CVODE
