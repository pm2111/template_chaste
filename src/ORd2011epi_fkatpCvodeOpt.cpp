...
class CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables()
    {
        if (_lookup_table_0)
        {
            delete[] _lookup_table_0;
...
protected:
    CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables(const CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables&);
    CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables& operator= (const CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables&);
    CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables()
    {
        ...
        mTableMins[0] = -130.001;
        mTableSteps[0] = 0.001;
        mTableStepInverses[0] = 1000.0;
        mTableMaxs[0] = 99.9999;
        mNeedsRegeneration[0] = true;
        _lookup_table_0 = NULL;
        CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            const unsigned _table_size_0 = 1 + (unsigned)((mTableMaxs[0]-mTableMins[0])/mTableSteps[0]);
...
private:
    ...
    static std::shared_ptr<CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables> CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellORd2011epi_fkatpFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellORd2011epi_fkatpFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellORd2011epi_fkatpFromCellMLCvodeOpt::CellORd2011epi_fkatpFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellORd2011epi_fkatpFromCellMLCvodeOpt>::Instance();
        Init();

        // We have a default stimulus specified in the CellML file metadata
        this->mHasDefaultStimulusFromCellML = true;
        NV_Ith_S(this->mParameters, 0) = 1.0; // (c,SERCA__Jup_b) [dimensionless]
        NV_Ith_S(this->mParameters, 1) = 1.8; // (c,extracellular__cao) [millimolar]
        NV_Ith_S(this->mParameters, 2) = 5.4; // (c,extracellular__ko) [millimolar]
        NV_Ith_S(this->mParameters, 3) = 140; // (c,extracellular__nao) [millimolar]
        NV_Ith_S(this->mParameters, 4) = 1; // (c,ryr__Jrel_b) [dimensionless]
        NV_Ith_S(this->mParameters, 5) = 0.0001; // (c,ICaL__PCa_b) [dimensionless]
        NV_Ith_S(this->mParameters, 6) = 0.0; // (c,I_katp__fkatp) [dimensionless]
        NV_Ith_S(this->mParameters, 7) = 75; // (c,INa__GNa) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 8) = 0.1908; // (c,IK1__GK1_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 9) = 0.0075; // (c,INaL__GNaL_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 10) = 0.046; // (c,IKr__GKr_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 11) = 0.0034; // (c,IKs__GKs_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 12) = 0.0008; // (c,INaCa_i__Gncx_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 13) = 30; // (c,INaK__Pnak_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 14) = 0.02; // (c,Ito__Gto_b) [milliS_per_microF]
    }
    
    CellORd2011epi_fkatpFromCellMLCvodeOpt::~CellORd2011epi_fkatpFromCellMLCvodeOpt()
    {
    }
    
    AbstractLookupTableCollection* CellORd2011epi_fkatpFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double CellORd2011epi_fkatpFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        // Units: millimolar; Initial value: 7
        ...
        // Units: millimolar; Initial value: 145
        ...
        const bool _oob_0 = CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellORd2011epi_fkatpFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_reversal_potentials__ENa = 26.712338705498265 * log(NV_Ith_S(mParameters, 3) / var_chaste_interface__intracellular_ions__nai); // millivolt
        ...
        const double var_ICaL__PCa = NV_Ith_S(mParameters, 5) * 1.2; // dimensionless
        ...
        const double var_ICaL__PhiCaL = (4.0 * ((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((var_chaste_interface__intracellular_ions__cass * _lt_0_row[8]) - (0.34100000000000003 * NV_Ith_S(mParameters, 1)))) / _lt_0_row[9]; // dimensionless
        ...
        const double var_ICaL__PhiCaNa = (1.0 * ((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((0.75 * var_chaste_interface__intracellular_ions__nass * _lt_0_row[10]) - (0.75 * NV_Ith_S(mParameters, 3)))) / _lt_0_row[11]; // dimensionless
        ...
        const double var_ICaL__PhiCaK = (1.0 * ((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((0.75 * var_chaste_interface__intracellular_ions__kss * _lt_0_row[12]) - (0.75 * NV_Ith_S(mParameters, 2)))) / _lt_0_row[13]; // dimensionless
        ...
        const double var_IKr__IKr = (NV_Ith_S(mParameters, 10) * 1.3) * sqrt(NV_Ith_S(mParameters, 2) * 0.18518518518518517) * ((_lt_0_row[14] * var_chaste_interface__IKr__xrf) + (_lt_0_row[15] * var_chaste_interface__IKr__xrs)) * _lt_0_row[16] * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        const double var_IKs__IKs = (NV_Ith_S(mParameters, 11) * 1.3999999999999999) * (1.0 + (0.59999999999999998 / (1.0 + pow(3.8000000000000002e-05 / var_chaste_interface__intracellular_ions__cai, 1.3999999999999999)))) * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2 * (var_chaste_interface__membrane__v - (26.712338705498265 * log((NV_Ith_S(mParameters, 2) + (0.018329999999999999 * NV_Ith_S(mParameters, 3))) / (var_chaste_interface__intracellular_ions__ki + (0.018329999999999999 * var_chaste_interface__intracellular_ions__nai))))); // microA_per_microF
        const double var_IK1__IK1 = (NV_Ith_S(mParameters, 8) * 1.2) * sqrt(NV_Ith_S(mParameters, 2)) * (1.0 / (1.0 + exp(((var_chaste_interface__membrane__v + 105.8) - (2.6000000000000001 * NV_Ith_S(mParameters, 2))) * 0.10534077741493732))) * var_chaste_interface__IK1__xk1 * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        const double var_I_katp__I_katp = NV_Ith_S(mParameters, 6) * pow(NV_Ith_S(mParameters, 2) * 0.18518518518518517, 0.23999999999999999) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK) * 0.067692307692307704; // microA_per_microF
        ...
        const double var_INaCa_i__h7_i = 1.0 + ((NV_Ith_S(mParameters, 3) * 0.011348161597821153) * _lt_0_row[19]); // dimensionless
        const double var_INaCa_i__h8_i = NV_Ith_S(mParameters, 3) / (88.120000000000005 * _lt_0_row[20] * var_INaCa_i__h7_i); // dimensionless
        const double var_INaCa_i__k3pp_i = var_INaCa_i__h8_i * 5000.0; // dimensionless
        const double var_INaCa_i__h10_i = ((NV_Ith_S(mParameters, 3) * 0.066666666666666666) * (1.0 + (NV_Ith_S(mParameters, 3) * 0.20000000000000001))) + 13.5; // dimensionless
        const double var_INaCa_i__k8_i = var_INaCa_i__h8_i * ((NV_Ith_S(mParameters, 3) * NV_Ith_S(mParameters, 3)) / (var_INaCa_i__h10_i * 75.0)) * 60000.0; // dimensionless
        const double var_INaCa_i__k1_i = (1.0 / var_INaCa_i__h10_i) * NV_Ith_S(mParameters, 1) * 1500000.0; // dimensionless
        ...
        const double var_INaCa_i__Gncx = NV_Ith_S(mParameters, 12) * 1.1000000000000001; // milliS_per_microF
        ...
        const double var_INaCa_i__h10_ss = ((NV_Ith_S(mParameters, 3) * 0.066666666666666666) * (1.0 + (NV_Ith_S(mParameters, 3) * 0.20000000000000001))) + 13.5; // dimensionless
        const double var_INaCa_i__h7_ss = 1.0 + ((NV_Ith_S(mParameters, 3) * 0.011348161597821153) * _lt_0_row[24]); // dimensionless
        const double var_INaCa_i__h8_ss = NV_Ith_S(mParameters, 3) / (88.120000000000005 * _lt_0_row[25] * var_INaCa_i__h7_ss); // dimensionless
        const double var_INaCa_i__k8_ss = var_INaCa_i__h8_ss * ((NV_Ith_S(mParameters, 3) * NV_Ith_S(mParameters, 3)) / (var_INaCa_i__h10_ss * 75.0)) * 60000.0; // dimensionless
        ...
        const double var_INaCa_i__k1_ss = (1.0 / var_INaCa_i__h10_ss) * NV_Ith_S(mParameters, 1) * 1500000.0; // dimensionless
        ...
        const double var_INaK__a3 = (1899.0 * pow(NV_Ith_S(mParameters, 2) * 2.7917364600781687, 2.0)) / ((pow(1.0 + (NV_Ith_S(mParameters, 3) / _lt_0_row[31]), 3.0) + pow(1.0 + (NV_Ith_S(mParameters, 2) * 2.7917364600781687), 2.0)) - 1.0); // dimensionless
        const double var_INaK__b2 = (39.399999999999999 * pow(NV_Ith_S(mParameters, 3) / _lt_0_row[29], 3.0)) / ((pow(1.0 + (NV_Ith_S(mParameters, 3) / _lt_0_row[30]), 3.0) + pow(1.0 + (NV_Ith_S(mParameters, 2) * 2.7917364600781687), 2.0)) - 1.0); // dimensionless
        ...
        const double var_INaK__INaK = (NV_Ith_S(mParameters, 13) * 0.90000000000000002) * ((1.0 * (3.0 * (((var_INaK__x1 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * var_INaK__a3) - ((var_INaK__x2 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * var_INaK__b3)))) + (1.0 * (2.0 * (((var_INaK__x4 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * 9.120000000000001) - ((var_INaK__x3 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * var_INaK__a1))))); // microA_per_microF
        const double var_INab__INab = (3.75e-10 * ((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((var_chaste_interface__intracellular_ions__nai * _lt_0_row[34]) - NV_Ith_S(mParameters, 3))) / _lt_0_row[35]; // microA_per_microF
        ...
        const double var_ICab__ICab = (((var_chaste_interface__membrane__v * 9309355225.0) * 3.8799692706433766e-07) * ((var_chaste_interface__intracellular_ions__cai * _lt_0_row[36]) - (0.34100000000000003 * NV_Ith_S(mParameters, 1))) * 9.9999999999999995e-08) / _lt_0_row[37]; // microA_per_microF
    ...
    void CellORd2011epi_fkatpFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_ryr__Jrel = (NV_Ith_S(mParameters, 4) * (1.0 - var_ryr__fJrelp) * var_chaste_interface__ryr__Jrelnp) + (NV_Ith_S(mParameters, 4) * var_ryr__fJrelp * var_chaste_interface__ryr__Jrelp); // millimolar_per_millisecond
        ...
        const double d_dt_chaste_interface__IK1__xk1 = ((1.0 / (1.0 + exp((-(var_chaste_interface__membrane__v + (2.5537999999999998 * NV_Ith_S(mParameters, 2)) + 144.59)) / ((1.5691999999999999 * NV_Ith_S(mParameters, 2)) + 3.8115000000000001)))) - var_chaste_interface__IK1__xk1) / _lt_0_row[89]; // per_millisecond
    ...
    N_Vector CellORd2011epi_fkatpFromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        NV_Ith_S(dqs, 0) = var_chaste_interface__ICaL__ICaL;
        NV_Ith_S(dqs, 1) = var_chaste_interface__I_katp__I_katp;
        NV_Ith_S(dqs, 2) = var_chaste_interface__INa__INa;
        NV_Ith_S(dqs, 3) = var_INa__h;
        NV_Ith_S(dqs, 4) = var_chaste_interface__IK1__IK1;
        NV_Ith_S(dqs, 5) = var_chaste_interface__IKr__IKr;
        NV_Ith_S(dqs, 6) = var_chaste_interface__IKs__IKs;
        NV_Ith_S(dqs, 7) = var_chaste_interface__membrane__Istim;
        NV_Ith_S(dqs, 8) = var_chaste_interface__environment__time;
        return dqs;
    }
    
template<>
void OdeSystemInformation<CellORd2011epi_fkatpFromCellMLCvodeOpt>::Initialise(void)
{
    ...
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(7);
    ...
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(145);
...
CHASTE_CLASS_EXPORT(CellORd2011epi_fkatpFromCellMLCvodeOpt)
#endif // CHASTE_CVODE
