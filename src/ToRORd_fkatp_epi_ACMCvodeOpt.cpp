...
class CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables()
    {
        if (_lookup_table_0)
        {
            delete[] _lookup_table_0;
...
protected:
    CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables(const CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables&);
    CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables& operator= (const CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables&);
    CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables()
    {
        ...
        _lookup_table_0 = NULL;
        CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][58] = (4.5620000000000003 + (1.0 / ((0.39329999999999998 * exp((-(var_chaste_interface__membrane__v + 100.0)) * 0.01)) + (0.08004 * exp((var_chaste_interface__membrane__v + 50.0) * 0.060277275467148887))))) * (1.0 - (0.94999999999999996 / (1.0 + exp((var_chaste_interface__membrane__v + 70.0) * 0.20000000000000001))));
            }
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][70] = 7.0 + ((1.0 / ((0.0044999999999999997 * exp((-(var_chaste_interface__membrane__v + 20.0)) * 0.10000000000000001)) + (0.0044999999999999997 * exp((var_chaste_interface__membrane__v + 20.0) * 0.10000000000000001)))) * 2466.0999999999999);
            }
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][72] = 1000.0 + ((1.0 / ((3.4999999999999997e-05 * exp((-(var_chaste_interface__membrane__v + 5.0)) * 0.25)) + (3.4999999999999997e-05 * exp((var_chaste_interface__membrane__v + 5.0) * 0.16666666666666666)))) * 10.3687);
            }
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][74] = 7.0 + ((1.0 / ((0.040000000000000001 * exp((-(var_chaste_interface__membrane__v - 4.0)) * 0.14285714285714285)) + (0.040000000000000001 * exp((var_chaste_interface__membrane__v - 4.0) * 0.14285714285714285)))) * 8953.0);
            }
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][76] = 100.0 + ((1.0 / ((0.00012 * exp((-var_chaste_interface__membrane__v) * 0.33333333333333331)) + (0.00012 * exp(var_chaste_interface__membrane__v * 0.14285714285714285)))) * 369.67000000000002);
            }
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][79] = 2.5 * (7.0 + ((1.0 / ((0.0044999999999999997 * exp((-(var_chaste_interface__membrane__v + 20.0)) * 0.10000000000000001)) + (0.0044999999999999997 * exp((var_chaste_interface__membrane__v + 20.0) * 0.10000000000000001)))) * 2466.0999999999999));
            }
            ...
            {
                const double var_chaste_interface__membrane__v = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][81] = 2.5 * (7.0 + ((1.0 / ((0.040000000000000001 * exp((-(var_chaste_interface__membrane__v - 4.0)) * 0.14285714285714285)) + (0.040000000000000001 * exp((var_chaste_interface__membrane__v - 4.0) * 0.14285714285714285)))) * 8953.0));
            }
...
private:
    ...
    static std::shared_ptr<CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables> CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 9);
    }
    
    CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt::CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                43,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt>::Instance();
        Init();
    ...
    CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt::~CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt()
    {
    }
    
    AbstractLookupTableCollection* CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        // Units: millivolt; Initial value: -89.1400
        ...
        // Units: dimensionless; Initial value: 0.8360
        ...
        const bool _oob_0 = CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_INa__fINap = 1.0 / (1.0 + (0.033000000000000002 / var_CaMK__CaMKa)); // dimensionless
        ...
        const double var_INaL__fINaLp = 1.0 / (1.0 + (0.033000000000000002 / var_CaMK__CaMKa)); // dimensionless
        const double var_INaL__INaL = (NV_Ith_S(mParameters, 8) * 0.59999999999999998) * (var_chaste_interface__membrane__v - var_reversal_potentials__ENa) * var_chaste_interface__INaL__mL * (((1.0 - var_INaL__fINaLp) * var_chaste_interface__INaL__hL) + (var_INaL__fINaLp * var_chaste_interface__INaL__hLp)); // microA_per_microF
        ...
        const double var_Ito__fItop = 1.0 / (1.0 + (0.033000000000000002 / var_CaMK__CaMKa)); // dimensionless
        ...
        const double var_ICaL__fICaLp = 1.0 / (1.0 + (0.033000000000000002 / var_CaMK__CaMKa)); // dimensionless
        ...
        const double var_ICaL__PCa = NV_Ith_S(mParameters, 4) * 1.2; // dimensionless
        ...
        const double var_ICaL__ICaL = (var_ICaL__ICaL_ss + var_ICaL__ICaL_i) * 0.97799999999999998; // microA_per_microF
        ...
        const double var_IKb__IKb = 0.011339999999999999 * _lt_0_row[36] * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
    ...
    void CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_SERCA__fJupp = 1.0 / (1.0 + (0.033000000000000002 / var_CaMK__CaMKa)); // dimensionless
        const double var_SERCA__Jup = 0.58930000000000005 * NV_Ith_S(mParameters, 2) * ((((1.0 - var_SERCA__fJupp) * ((var_chaste_interface__intracellular_ions__cai * 0.0070525000000000006) / (var_chaste_interface__intracellular_ions__cai + 0.00092000000000000003))) + (var_SERCA__fJupp * ((var_chaste_interface__intracellular_ions__cai * 0.019394375000000002) / ((var_chaste_interface__intracellular_ions__cai + 0.00092000000000000003) - 0.00017000000000000001)))) - ((0.0048824999999999997 * var_chaste_interface__intracellular_ions__cansr) * 0.066666666666666666)); // millimolar_per_millisecond
        ...
        const double var_ryr__fJrelp = 1.0 / (1.0 + (0.033000000000000002 / var_CaMK__CaMKa)); // dimensionless
        const double var_ryr__Jrel = 0.37940000000000002 * NV_Ith_S(mParameters, 1) * (((1.0 - var_ryr__fJrelp) * var_chaste_interface__ryr__Jrel_np) + (var_ryr__fJrelp * var_chaste_interface__ryr__Jrel_p)); // millimolar_per_millisecond
        ...
        const double d_dt_chaste_interface__ryr__Jrel_np = (((( -2.375 * var_ICaL__ICaL_ss) * 1.0) / (1.0 + pow(1.7 / var_chaste_interface__intracellular_ions__cajsr, 8.0))) - var_chaste_interface__ryr__Jrel_np) / ((var_ryr__tau_rel_b < 0.001) ? 0.001 : var_ryr__tau_rel_b); // 'millimolar per millisecond per millisecond'
        const double d_dt_chaste_interface__ryr__Jrel_p = (((( -2.96875 * var_ICaL__ICaL_ss) * 1.0) / (1.0 + pow(1.7 / var_chaste_interface__intracellular_ions__cajsr, 8.0))) - var_chaste_interface__ryr__Jrel_p) / ((var_ryr__tau_relp_b < 0.001) ? 0.001 : var_ryr__tau_relp_b); // 'millimolar per millisecond per millisecond'
...
template<>
void OdeSystemInformation<CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt>::Initialise(void)
{
    ...
    this->mInitialConditions.push_back(-89.1400);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.8360);
...
CHASTE_CLASS_EXPORT(CellToRORd_fkatp_epi_ACMFromCellMLCvodeOpt)
#endif // CHASTE_CVODE
