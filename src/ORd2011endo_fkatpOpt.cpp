...
//! on Thu Feb 14 17:09:08 2019
//! 
//! <autogenerated>

#include "ORd2011endo_fkatpOpt.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
class CellORd2011endo_fkatpFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellORd2011endo_fkatpFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellORd2011endo_fkatpFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellORd2011endo_fkatpFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellORd2011endo_fkatpFromCellMLOpt_LookupTables()
    {
        if (_lookup_table_0)
        {
            delete[] _lookup_table_0;
...
protected:
    CellORd2011endo_fkatpFromCellMLOpt_LookupTables(const CellORd2011endo_fkatpFromCellMLOpt_LookupTables&);
    CellORd2011endo_fkatpFromCellMLOpt_LookupTables& operator= (const CellORd2011endo_fkatpFromCellMLOpt_LookupTables&);
    CellORd2011endo_fkatpFromCellMLOpt_LookupTables()
    {
        ...
        _lookup_table_0 = NULL;
        CellORd2011endo_fkatpFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellORd2011endo_fkatpFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellORd2011endo_fkatpFromCellMLOpt_LookupTables> CellORd2011endo_fkatpFromCellMLOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellORd2011endo_fkatpFromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellORd2011endo_fkatpFromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[9];
    }
    
    CellORd2011endo_fkatpFromCellMLOpt::CellORd2011endo_fkatpFromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellORd2011endo_fkatpFromCellMLOpt>::Instance();
        Init();
    ...
    CellORd2011endo_fkatpFromCellMLOpt::~CellORd2011endo_fkatpFromCellMLOpt()
    {
    }
    
    AbstractLookupTableCollection* CellORd2011endo_fkatpFromCellMLOpt::GetLookupTableCollection()
    {
        return CellORd2011endo_fkatpFromCellMLOpt_LookupTables::Instance();
    }
    
    double CellORd2011endo_fkatpFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellORd2011endo_fkatpFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellORd2011endo_fkatpFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_IKr__IKr = mParameters[10] * sqrt(mParameters[2] * 0.18518518518518517) * ((_lt_0_row[14] * var_chaste_interface__IKr__xrf) + (_lt_0_row[15] * var_chaste_interface__IKr__xrs)) * _lt_0_row[16] * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_IK1__IK1 = mParameters[8] * sqrt(mParameters[2]) * (1.0 / (1.0 + exp(((var_chaste_interface__membrane__v + 105.8) - (2.6000000000000001 * mParameters[2])) * 0.10534077741493732))) * var_chaste_interface__IK1__xk1 * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_INaCa_i__Gncx = mParameters[12]; // milliS_per_microF
    ...
    void CellORd2011endo_fkatpFromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> CellORd2011endo_fkatpFromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<CellORd2011endo_fkatpFromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellORd2011endo_fkatpFromCellMLOpt)
